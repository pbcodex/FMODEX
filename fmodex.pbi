...
If fmodLib
  ...
  Prototype.l FMOD_Memory_GetStats_Prototype(*currentalloced, *maxalloced)
  ...
  ;- FMOD_Debug_GetLevel
  Prototype.l FMOD_Debug_GetLevel_Prototype(*level)
  ...
  Prototype.l FMOD_File_GetDiskBusy_Prototype(*busy)
  ...
  Prototype.l FMOD_System_GetOutput_Prototype(system.l, *Output)
  ...
  Prototype.l FMOD_System_GetNumDrivers_Prototype(system.l, *Numdrivers)
  ...
  Prototype.l FMOD_System_GetDriverName_Prototype(system.l, id.l, *name, Namelen.l)
  ...
  Prototype.l FMOD_System_GetDriverCaps_Prototype(system.l, id.l, *caps, *minfrequency, *maxfrequency, *controlpanelspeakermode)
  ...
  Prototype.l FMOD_System_GetDriver_Prototype (system.l, *Driver)
  ...
  Prototype.l FMOD_System_GetHardwareChannels_Prototype (system.l, *Num2d, *Num3d, *total)
  ...
  Prototype.l FMOD_System_GetSoftwareChannels_Prototype (system.l, *Numsoftwarechannels)
  ...
  Prototype.l FMOD_System_GetSoftwareFormat_Prototype (system.l, *Samplerate, *Format, *Numoutputchannels, *Maxinputchannels, *Resamplemethod, *Bits)
  ...
  Prototype.l FMOD_System_GetDSPBufferSize_Prototype (system.l, *Bufferlength, *Numbuffers)
  ...
  Prototype.l FMOD_System_SetAdvancedSettings_Prototype (system.l, *settings)
  ...
  Prototype.l FMOD_System_GetAdvancedSettings_Prototype (system.l, *settings)
  ...
  Prototype.l FMOD_System_GetSpeakerMode_Prototype (system.l, *Speakermode)
  ...
  Prototype.l FMOD_System_LoadPlugin_Prototype (system.l, Filename.s, *Plugintype, *Index)
  ...
  Prototype.l FMOD_System_GetNumPlugins_Prototype (system.l, Plugintype.l, *Numplugins)
  ...
  Prototype.l FMOD_System_GetPluginInfo_Prototype (system.l, Plugintype.l, Index.l, *name, Namelen.l, *version)
  ...
  Prototype.l FMOD_System_UnloadPlugin_Prototype (system.l, Plugintype.l, *Index)
  ...
  Prototype.l FMOD_System_GetOutputByPlugin_Prototype (system.l, *Index)
  ...
  Prototype.l FMOD_System_Get3DSettings_Prototype (system.l, *Dopplerscale, *Distancefactor, *Rolloffscale)
  ...
  Prototype.l FMOD_System_Get3DNumListeners_Prototype (system.l, *Numlisteners)
  ...
  Prototype.l FMOD_System_Set3DListenerAttributes_Prototype (system.l, Listener.l, *Pos, *Vel, *Forward, *Up)
  ...
  Prototype.l FMOD_System_Get3DListenerAttributes_Prototype (system.l, Listener.l, *Pos, *Vel, *Forward, *Up)
  ...
  Prototype.l FMOD_System_GetSpeakerPosition_Prototype (system.l, *Speaker, *X, *Y)
  ...
  Prototype.l FMOD_System_GetStreamBufferSize_Prototype (system.l, *Filebuffersize, *Filebuffersizetype)
  ...
  Prototype.l FMOD_System_GetVersion_Prototype (system.l, *version)
  ...
  Prototype.l FMOD_System_GetOutputHandle_Prototype (system.l, *Handle)
  ...
  Prototype.l FMOD_System_GetChannelsPlaying_Prototype (system.l, *Channels)
  ...
  Prototype.l FMOD_System_GetCPUUsage_Prototype (system.l, *Dsp, *Stream, *Update, *total)
  ...
  Prototype.l FMOD_System_GetSoundRAM_Prototype (system.l, *currentalloced, *maxalloced, *total)
  ...
  Prototype.l FMOD_System_GetNumCDROMDrives_Prototype (system.l, *Numdrives)
  ...
  Prototype.l FMOD_System_GetCDROMDriveName_Prototype (system.l, Drive.l, *Drivename, Drivenamelen.l, *Scsiname, Scsinamelen.l, *Devicename, Devicenamelen.l)
  ...
  Prototype.l FMOD_System_GetSpectrum_Prototype (system.l, *Spectrumarray, Numvalues.l, Channeloffset.l, *Windowtype)
  ...
  Prototype.l FMOD_System_CreateSound_Prototype (system.l, Name_or_data.l, Mode.l, *exinfo, *Sound)
  ...
  Prototype.l FMOD_System_CreateDSP_Prototype (system.l, *description, *Dsp)
  ...
  Prototype.l FMOD_System_CreateDSPByType_Prototype (system.l, dsptype.l, *Dsp)
  ...
  Prototype.l FMOD_System_CreateDSPByIndex_Prototype (system.l, Index.l, *Dsp)
  ...
  Prototype.l FMOD_System_CreateChannelGroup_Prototype (system.l, name.s, *Channelgroup)
  ...
  Prototype.l FMOD_System_PlayDSP_Prototype (system.l, channelid.l, Dsp.l, paused.l, *channel)
  ...
  Prototype.l FMOD_System_GetChannel_Prototype (system.l, channelid.l, *channel)
  ...
  Prototype.l FMOD_System_GetMasterChannelGroup_Prototype (system.l, *Channelgroup)
  ...
  Prototype.l FMOD_System_SetReverbProperties_Prototype (system.l, *Prop)
  ...
  Prototype.l FMOD_System_GetReverbProperties_Prototype (system.l, *Prop)
  ...
  Prototype.l FMOD_System_GetDSPHead_Prototype (system.l, *Dsp)
  ...
  Prototype.l FMOD_System_GetRecordDriver_Prototype (system.l, *Driver)
  ...
  Prototype.l FMOD_System_GetRecordNumDrivers_Prototype (system.l, *Numdrivers)
  ...
  Prototype.l FMOD_System_GetRecordDriverName_Prototype (system.l, id.l, *name, Namelen.l)
  ...
  Prototype.l FMOD_System_GetRecordPosition_Prototype (system.l, *Position)
  ...
  Prototype.l FMOD_System_IsRecording_Prototype (system.l, *Recording)
  ...
  Prototype.l FMOD_System_CreateGeometry_Prototype (system.l, MaxPolygons.l, MaxVertices.l, *Geometryf)
  ...
  Prototype.l FMOD_System_GetGeometrySettings_Prototype (system.l, *Maxworldsize)
  ...
  Prototype.l FMOD_System_LoadGeometry_Prototype (system.l, _data.l, _dataSize.l, *Geometry)
  ...
  Prototype.l FMOD_System_GetNetworkProxy_Prototype (system.l, *Proxy, Proxylen.l)
  ...
  Prototype.l FMOD_System_GetNetworkTimeout_Prototype (system.l, *timeout)
  ...
  Prototype.l FMOD_System_GetUserData_Prototype (system.l, *userdata)
  ...
  Prototype.l FMOD_Sound_GetSystemObject_Prototype (sound.l, *system)
  ...
  ;- FMOD_Sound_Lock_
  Prototype.l FMOD_Sound_Lock_Prototype (sound.l, Offset.l, Length.l, *Ptr1, *Ptr2, *Len1, *Len2)
  ...
  Prototype.l FMOD_Sound_GetDefaults_Prototype (sound.l, *Frequency, *Volume, *Pan, *Priority)
  ...
  Prototype.l FMOD_Sound_GetVariations_Prototype (sound.l, *Frequencyvar, *Volumevar, *Panvar)
  ...
  Prototype.l FMOD_Sound_Get3DMinMaxDistance_Prototype (sound.l, *min, *max)
  ...
  Prototype.l FMOD_Sound_Get3DConeSettings_Prototype (sound.l, *Insideconeangle, *Outsideconeangle, *Outsidevolume)
  ...
  Prototype.l FMOD_Sound_Set3DCustomRolloff_Prototype (sound.l, *Points, numpoints.l)
  ...
  Prototype.l FMOD_Sound_Get3DCustomRolloff_Prototype (sound.l, *Points, *numpoints)
  ...
  Prototype.l FMOD_Sound_GetSubSound_Prototype (sound.l, Index.l, *Subsound)
  ...
  Prototype.l FMOD_Sound_SetSubSoundSentence_Prototype (sound.l, *Subsoundlist, Numsubsounds.l)
  ...
  ;- FMOD_Sound_GetName_
  Prototype.l FMOD_Sound_GetName_Prototype (sound.l, *name, Namelen.l)
  ...
  Prototype.l FMOD_Sound_GetFormat_Prototype (sound.l, *Soundtype, *Format, *Channels, *Bits)
  ...
  Prototype.l FMOD_Sound_GetNumSubSounds_Prototype (sound.l, *Numsubsounds)
  ...
  Prototype.l FMOD_Sound_GetOpenState_Prototype (sound.l, *Openstate, *Percentbuffered, *Starving)
  ...
  Prototype.l FMOD_Sound_ReadData_Prototype (sound.l, Buffer.l, Lenbytes.l, *_Read)
  ...
  Prototype.l FMOD_Sound_GetNumSyncPoints_Prototype (sound.l, *Numsyncpoints)
  ...
  Prototype.l FMOD_Sound_GetSyncPoint_Prototype (sound.l, Index.l, *Point)
  ...
  Prototype.l FMOD_Sound_GetSyncPointInfo_Prototype (sound.l, Point.l, *name, Namelen.l, *Offset, Offsettype.l)
  ...
  Prototype.l FMOD_Sound_AddSyncPoint_Prototype (sound.l, Offset.l, Offsettype.l, name.s, *Point)
  ...
  ;- FMOD_Sound_GetMode_
  Prototype.l FMOD_Sound_GetMode_Prototype (sound.l, *Mode)
  ...
  Prototype.l FMOD_Sound_GetLoopCount_Prototype (sound.l, *Loopcount)
  ...
  Prototype.l FMOD_Sound_GetLoopPoints_Prototype (sound.l, *Loopstart, Loopstarttype.l, *Loopend, Loopendtype.l)
  ...
  Prototype.l FMOD_Sound_GetUserData_Prototype (sound.l, *userdata)
  ...
  Prototype.l FMOD_Channel_GetSystemObject_Prototype (channel.l, *system)
  ...
  Prototype.l FMOD_Channel_GetVolume_Prototype(channel.l, *Volume)
  ...
  Prototype.l FMOD_Channel_GetFrequency_Prototype (channel.l, *Frequency)
  ...
  Prototype.l FMOD_Channel_GetPan_Prototype (channel.l, *Pan)
  ...
  Prototype.l FMOD_Channel_GetDelay_Prototype (channel.l, *Startdelay, *Enddelay)
  ...
  Prototype.l FMOD_Channel_GetSpeakerMix_Prototype (channel.l, *Frontleft, *Frontright, *Center, *Lfe, *Backleft, *Backright, *Sideleft, *Sideright)
  ...
  Prototype.l FMOD_Channel_SetSpeakerLevels_Prototype (channel.l, Speaker.l, *Levels, Numlevels.l)
  ...
  Prototype.l FMOD_Channel_GetSpeakerLevels_Prototype (channel.l, Speaker.l, *Levels, Numlevels.l)
  ...
  Prototype.l FMOD_Channel_GetMute_Prototype (channel.l, *Mute)
  ...
  Prototype.l FMOD_Channel_GetPriority_Prototype (channel.l, *Priority)
  ...
  Prototype.l FMOD_Channel_SetReverbProperties_Prototype (channel.l, *Prop)
  ...
  Prototype.l FMOD_Channel_GetReverbProperties_Prototype (channel.l, *Prop)
  ...
  Prototype.l FMOD_Channel_GetChannelGroup_Prototype (channel.l, *Channelgroup)
  ...
  Prototype.l FMOD_Channel_Set3DAttributes_Prototype (channel.l, *Pos, *Vel)
  ...
  Prototype.l FMOD_Channel_Get3DAttributes_Prototype (channel.l, *Pos, *Vel)
  ...
  Prototype.l FMOD_Channel_Get3DMinMaxDistance_Prototype (channel.l, *Mindistance, *Maxdistance)
  ...
  Prototype.l FMOD_Channel_Get3DConeSettings_Prototype (channel.l, *Insideconeangle, *Outsideconeangle, *Outsidevolume)
  ...
  Prototype.l FMOD_Channel_Set3DConeOrientation_Prototype (channel.l, *Orientation)
  ...
  Prototype.l FMOD_Channel_Get3DConeOrientation_Prototype (channel.l, *Orientation)
  ...
  Prototype.l FMOD_Channel_Set3DCustomRolloff_Prototype (channel.l, *Points, numpoints.l)
  ...
  Prototype.l FMOD_Channel_Get3DCustomRolloff_Prototype (channel.l, *Points, *numpoints)
  ...
  Prototype.l FMOD_Channel_Get3DOcclusion_Prototype (channel.l, *DirectOcclusion, *ReverbOcclusion)
  ...
  Prototype.l FMOD_Channel_Get3DSpread_Prototype (channel.l, *angle)
  ...
  Prototype.l FMOD_Channel_Get3DPanLevel_Prototype (channel.l, *float)
  ...
  Prototype.l FMOD_Channel_Get3DDopplerLevel_Prototype (channel.l, *level)
  ...
  Prototype.l FMOD_Channel_GetDSPHead_Prototype (channel.l, *Dsp)
  ...
  Prototype.l FMOD_Channel_IsVirtual_Prototype (channel.l, *Isvirtual)
  ...
  Prototype.l FMOD_Channel_GetAudibility_Prototype (channel.l, *Audibility)
  ...
  Prototype.l FMOD_Channel_GetCurrentSound_Prototype (channel.l, *Sound)
  ...
  Prototype.l FMOD_Channel_GetWaveData_Prototype (channel.l, *Wavearray, Numvalues.l, Channeloffset.l)
  ...
  Prototype.l FMOD_Channel_GetIndex_Prototype (channel.l, *Index)
  ...
  Prototype.l FMOD_Channel_GetMode_Prototype (channel.l, *Mode)
  ...
  Prototype.l FMOD_Channel_GetLoopCount_Prototype (channel.l, *Loopcount)
  ...
  Prototype.l FMOD_Channel_GetLoopPoints_Prototype (channel.l, *Loopstart, Loopstarttype.l, *Loopend, Loopendtype.l)
  ...
  Prototype.l FMOD_Channel_GetUserData_Prototype (channel.l, *userdata)
  ...
  Prototype.l FMOD_ChannelGroup_GetSystemObject_Prototype (Channelgroup.l, *system)
  ...
  Prototype.l FMOD_ChannelGroup_GetVolume_Prototype (Channelgroup.l, *Volume)
  ...
  Prototype.l FMOD_ChannelGroup_GetPitch_Prototype (Channelgroup.l, *Pitch)
  ...
  Prototype.l FMOD_ChannelGroup_OverrideReverbProperties_Prototype (Channelgroup.l, *Prop)
  ...
  Prototype.l FMOD_ChannelGroup_Override3DAttributes_Prototype (Channelgroup.l, *Pos, *Vel)
  ...
  Prototype.l FMOD_ChannelGroup_GetNumGroups_Prototype (Channelgroup.l, *Numgroups)
  ...
  Prototype.l FMOD_ChannelGroup_GetGroup_Prototype (Channelgroup.l, Index.l, *Group)
  ...
  Prototype.l FMOD_ChannelGroup_GetDSPHead_Prototype (Channelgroup.l, *Dsp)
  ...
  Prototype.l FMOD_ChannelGroup_GetName_Prototype (Channelgroup.l, *name, Namelen.l)
  ...
  Prototype.l FMOD_ChannelGroup_GetNumChannels_Prototype (Channelgroup.l, *Numchannels)
  ...
  Prototype.l FMOD_ChannelGroup_GetChannel_Prototype (Channelgroup.l, Index.l, *channel)
  ...
  Prototype.l FMOD_ChannelGroup_GetSpectrum_Prototype (Channelgroup.l, *Spectrumarray, Numvalues.l, Channeloffset.l, Windowtype.l)
  ...
  Prototype.l FMOD_ChannelGroup_GetWaveData_Prototype (Channelgroup.l, *Wavearray, Numvalues.l, Channeloffset.l)
  ...
  Prototype.l FMOD_ChannelGroup_GetUserData_Prototype (Channelgroup.l, *userdata)
  ...
  Prototype.l FMOD_DSP_GetSystemObject_Prototype (Dsp.l, *system)
  ...
  Prototype.l FMOD_DSP_GetNumInputs_Prototype (Dsp.l, *Numinputs)
  ...
  Prototype.l FMOD_DSP_GetNumOutputs_Prototype (Dsp.l, *Numoutputs)
  ...
  ;- FMOD_DSP_GetInput_
  Prototype.l FMOD_DSP_GetInput_Prototype (Dsp.l, Index.l, *Input)
  Global FMOD_DSP_GetInput.FMOD_DSP_GetInput_Prototype
  FMOD_DSP_GetInput = GetFunction(fmodLib, "FMOD_DSP_GetInput")
  
  ;- FMOD_DSP_GetOutput_
  Prototype.l FMOD_DSP_GetOutput_Prototype (Dsp.l, Index.l, *Output)
  ...
  Prototype.l FMOD_DSP_SetInputLevels_Prototype (Dsp.l, Index.l, Speaker.l, *Levels, Numlevels.l)
  ...
  Prototype.l FMOD_DSP_GetInputLevels_Prototype (Dsp.l, Index.l, Speaker.l, *Levels, Numlevels.l)
  ...
  Prototype.l FMOD_DSP_SetOutputLevels_Prototype (Dsp.l, Index.l, Speaker.l, *Levels, Numlevels.l)
  ...
  Prototype.l FMOD_DSP_GetOutputLevels_Prototype (Dsp.l, Index.l, Speaker.l, *Levels, Numlevels.l)
  ...
  ;- FMOD_DSP_GetActive_
  Prototype.l FMOD_DSP_GetActive_Prototype (Dsp.l, *Active)
  ...
  ;- FMOD_DSP_GetBypass_
  Prototype.l FMOD_DSP_GetBypass_Prototype (Dsp.l, *Bypass)
  ...
  Prototype.l FMOD_DSP_GetParameter_Prototype (Dsp.l, Index.l, *Value, *Valuestr, Valuestrlen.l)
  ...
  Prototype.l FMOD_DSP_GetNumParameters_Prototype (Dsp.l, *Numparams)
  ...
  Prototype.l FMOD_DSP_GetParameterInfo_Prototype (Dsp.l, Index.l, *name, *label, *description, Descriptionlen.l, *min, *max)
  ...
  ;- FMOD_DSP_GetInfo_
  Prototype.l FMOD_DSP_GetInfo_Prototype (Dsp.l, *name, *version, *Channels, *Configwidth, *Configheight)
  ...
  Prototype.l FMOD_DSP_GetDefaults_Prototype (Dsp.l, *Frequency, *Volume, *Pan, *Priority)
  ...
  Prototype.l FMOD_DSP_GetUserData_Prototype (Dsp.l, *userdata)
  ...
  Prototype.l FMOD_Geometry_AddPolygon_Prototype (Geometry.l, DirectOcclusion.f, ReverbOcclusion.f, DoubleSided.l, NumVertices.l, *Vertices, *PolygonIndex)
  ...
  Prototype.l FMOD_Geometry_GetNumPolygons_Prototype (Geometry.l, *NumPolygons)
  ...
  Prototype.l FMOD_Geometry_GetMaxPolygons_Prototype (Geometry.l, *MaxPolygons, *MaxVertices)
  ...
  Prototype.l FMOD_Geometry_GetPolygonNumVertices_Prototype (Geometry.l, PolygonIndex.l, *NumVertices)
  ...
  Prototype.l FMOD_Geometry_SetPolygonVertex_Prototype (Geometry.l, PolygonIndex.l, VertexIndex.l, *Vertex)
  ...
  Prototype.l FMOD_Geometry_GetPolygonVertex_Prototype (Geometry.l, PolygonIndex.l, VertexIndex.l, *Vertex)
  ...
  Prototype.l FMOD_Geometry_GetPolygonAttributes_Prototype (Geometry.l, PolygonIndex.l, *DirectOcclusion, *ReverbOcclusion, *DoubleSided)
  ...
  Prototype.l FMOD_Geometry_GetActive_Prototype (Geometry.l, *Active)
  ...
  Prototype.l FMOD_Geometry_SetRotation_Prototype (Geometry.l, *Forward, *Up)
  ...
  Prototype.l FMOD_Geometry_GetRotation_Prototype (Geometry.l, *Forward, *Up)
  ...
  Prototype.l FMOD_Geometry_SetPosition_Prototype (Geometry.l, *Position)
  ...
  Prototype.l FMOD_Geometry_GetPosition_Prototype (Geometry.l, *Position)
  ...
  Prototype.l FMOD_Geometry_SetScale_Prototype (Geometry.l, *Scale)
  ...
  Prototype.l FMOD_Geometry_GetScale_Prototype (Geometry.l, *Scale)
  ...
  ;- FMOD_Geometry_Save_
  Prototype.l FMOD_Geometry_Save_Prototype (Geometry.l, _data.l, *_dataSize)
  ...
  Prototype.l FMOD_Geometry_GetUserData_Prototype (Geometry.l, *userdata)
...
Procedure.s FMOD_ErrorString(errcode.l)
  ...
  Select errcode
    ...
    ;Case #FMOD_ERR_MUSIC_NOCALLBACK:       FMOD_ErrorString = "The music callback is required, but it has not been set."
